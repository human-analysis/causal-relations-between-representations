...
def parse_args():
    ...
    parser.add_argument('--w1', type=float, default=None, help='loss weights w1')
    parser.add_argument('--w2', type=float, default=None, help='loss weights w2')
    parser.add_argument('--w3', type=float, default=None, help='loss weights w3')
    parser.add_argument('--idx', type=int, default=None, help='dataset idx')
    parser.add_argument('--npairs', type=int, default=None, help='numbers of pairs in one sample')
    parser.add_argument('--ndimsx', type=int, default=None, help='dim of X')
    parser.add_argument('--ndimsy', type=int, default=None, help='dim of Y')
    parser.add_argument('--nranges', type=int, default=None, help='range for random noise')
